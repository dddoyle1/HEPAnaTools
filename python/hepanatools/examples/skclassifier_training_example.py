...
parser.add_argument(
    "--dataloader", help="Output of a TrainTestDataLoader", default=None
)
parser.add_argument(
    "--results", help=".model.h5 file output by the BDT object", default=None
)
parser.add_argument("--plots", help="Directory in which to place plots", default="./")
